...
namespace Store.Db.Migrations
{
    ...
    [Migration("20241014173955_UpdateChapterEdBookFromEdBookFromBalanceToBaseEdBook")]
    partial class UpdateChapterEdBookFromEdBookFromBalanceToBaseEdBook
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Books.EducationalBookInBalance", b =>
                {
                    ...
                    b.Property<Guid?>("book_debtor_school_ground_id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("book_debtor_school_ground_id");
