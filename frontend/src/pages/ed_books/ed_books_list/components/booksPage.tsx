...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TablePagination, Grid, Button } from '@mui/material';
    ...
    return (
        <div className="p-4">
            ...
            <TablePagination
                ...
                labelRowsPerPage="Книг на странице"
